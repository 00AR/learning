//map method transforms an array by applying a function to all of its elements and
// building a new array from returned values
//code starts from line 1148
...
//filter() is also a standard array method. Above function shows what it 
// does internally.
...
// built in reduce function. start can be omitted if array has at least one element
...
// this function expects a collection(anything that we can we loop over with for/of)
// and  a function that computes a group name for a given element.
// returns an array of objects, each of which names a group and tells you the number
// of elements that were found in that group.
...
// function that tells us which scripts are used in piece of text
